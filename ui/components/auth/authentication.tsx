...
function RegisterOrLoginPage({ type, path }: RegisterOrLoginPageProps) {
    return (
        <div className='h-screen flex pt-20  md:pt-0 md:items-center justify-center text-center text-white '>
            <div className='space-y-6 mx-2'>
                ...
                <div className=" w-[370px] md:w-[390px] shadow-xl border border-gray-800 rounded-md space-y-4 py-10">
                    ...
                    <RegisterBtn href={`${path}/google`} text={type === "signUp" ? "Sign Up With Google" : "Sign In With Google"} logo='/img/social/google.png' />
                    <RegisterBtn href={`${path}/apple`} text={type === "signUp" ? "Sign Up With Apple" : "Sign In With Apple"} logo='/img/social/apple.png' className="invert-[2]" />
                    <RegisterBtn href={`${path}/email`} text={type === "signUp" ? "Sign Up With Email" : "Sign In With Email"} logo='/img/social/email.png' className="invert-[2]" />
                </div>
